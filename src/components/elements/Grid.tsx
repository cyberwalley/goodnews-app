...
const Grid: FC<GridProps> = ({ children, layout = 'products' }) => {
  const layouts = {
    ...
    campaigns: 'px-4 md:px-8 mt-6 space-y-12 lg:grid lg:grid-cols-4 gap-8 lg:space-y-0',
    category:'mt-6 space-y-12 lg:grid lg:grid-cols-3 gap-8 lg:space-y-0',
    blogSection: 'px-4 md:px-8 mt-6 space-y-12 flex flex-col lg:flex-row gap-8 lg:space-y-0',
  };
