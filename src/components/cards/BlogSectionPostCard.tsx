...
const BlogSectionPostCard = () => {
  return (
    <div className="flex flex-col text-black  md:flex-row pb-[25px] mb-[30px] border-b">
      <div className="post__image w-auto md:w-[354px] md:mr-[25px]">
        <img
      ...
      <div className="post__content max-w-md">
        <h3 className="overflow-hidden whitespace-wrap line-clamp-2 text-2xl font-bold mb-2">
          How to watch the free Manchester United vs Aston Villa live stream
        </h3>
        <div className="post_except mb-4 mt-4 text-[14px] text-gray-700">
        ...
        <div className="post_info flex flex-wrap gap-1 items-center">
          <span className="post_breadcrumb rounded-full bg-[#fda4af] py-1 px-2 text-xs">
            Laptops
          </span>
          <span className="post_date"></span>
          <span className="post_author text-xs font-bold">Kola</span>
          <time
            className="text-xs"
...
export default BlogSectionPostCard;
