...
import { SITE_INSTAGRAM, SITE_LOGO, SITE_NAME, SITE_TWITTER } from '../utils/constants';
    ...
    <div className='max-w-[81rem] mx-auto px-4 flex h-96 items-center md:h-36'>
      ...
      <div className="flex w-full flex-row flex-wrap items-center justify-center gap-y-10 gap-x-10 xl:gap-x-20 md:flex-nowrap">
        ...
        <div className="flex flex-row gap-x-4 md:gap-x-6">
          <Link to={SITE_INSTAGRAM} target="_blank" rel="noreferrer" className='hover:translate-x-[-5px] hover:translate-y-[5px] shadow-3xl px-3 py-3 bg-white border-black border-2 transition shadow-5px hover:shadow-none'>
            <img
          ...
          <Link to={SITE_TWITTER} target="_blank" rel="noreferrer" className='hover:translate-x-[-5px] hover:translate-y-[5px] shadow-3xl px-3 py-3 bg-white border-black border-2 transition shadow-5px hover:shadow-none'>
            <img
              className="h-3 w-3 md:h-auto md:w-auto"
