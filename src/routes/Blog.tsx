...
const Blog = () => {
  ...
  return (
    <Layout>
      <MetaTags title="blog" description="decription" canonical={`tips`} />
      <header>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              {posts.map(post => (
                ...
                >
                  <img
                    src="https://prod-cdn-thekrazycouponlady.imgix.net/wp-content/uploads/2023/03/hobby-lobby-easter-sign-feature-image-1679182091-1679182091.png?auto=format&fit=crop&crop=faces&w=1106&h=600"
                    alt="hello"
                    title="hello"
                    loading="lazy"
